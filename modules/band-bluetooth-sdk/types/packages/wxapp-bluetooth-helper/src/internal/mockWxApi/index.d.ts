import * as bluetoothApis from '../bluetooth';
export type WxBluetoothApis = Exclude<typeof bluetoothApis, 'getApis' | 'setApis'>;
/**
 * 模拟小程序蓝牙 api
 */
export declare function mockWxBluetoothApi(): {
    ...
    openBluetoothAdapter: (option?: WechatMiniprogram.OpenBluetoothAdapterOption | undefined) => void;
    closeBluetoothAdapter: ((option?: WechatMiniprogram.CloseBluetoothAdapterOption | undefined) => void) | undefined;
