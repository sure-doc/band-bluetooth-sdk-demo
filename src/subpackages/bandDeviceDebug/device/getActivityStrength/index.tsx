...
import { GetActivityStrengthStore } from './index.store';
import { DataView } from '../../components/DataView';

const GetActivityStrength = () => {
  const store = useStore(GetActivityStrengthStore);
...
export default observer(GetActivityStrength);
